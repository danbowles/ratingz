defmodule Ratingz.SurveyTest do
  use Ratingz.DataCase
  import Ratingz.{AccountsFixtures, CatalogFixtures}
  alias Ratingz.Survey

  describe "demographics" do
    alias Ratingz.Survey.Demographic

    import Ratingz.SurveyFixtures
    ...
    test "create_demographic/1 with valid data creates a demographic" do
      valid_attrs = %{gender: "female", year_of_birth: 2002, user_id: user_fixture().id}
